    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                'id'       => 'support-info',
                'type'     => 'info',
                'desc'     => '<h3>Oh, something is wrong? I´m there!</h3><p>If you have any questions or issues, feel free to use our Support Center following <a href="http://wpdevs.io/support/">http://wpdevs.io/support/</a> or to open a new support thread on <a href="https://wordpress.org/support/plugin/better-facebook-page-box">https://wordpress.org/support/plugin/better-facebook-page-box</a></p>',
                'style'    => 'success'
            ),
        )
    ) );
